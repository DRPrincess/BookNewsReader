...
public class MyPartPresenter implements MyPartContact.Presenter {
    ...
    @NonNull
    private ArrayList<PartActivityBean> getDefaultData(String type) {
    ...
    public void getData(int page, int pageNum, int type, String searchContent) {
        ...
        NewsReposity.getInstance()
                ...
                .subscribe(new LoadingSubscriber<List<PartActivityBean>>(mContext,mContext.getString(R.string.msg_loading),true) {
